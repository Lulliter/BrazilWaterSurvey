...
+ Lack of **EFFICIENCY** is a major challenge for LAC WSS suppliers (also validated by  generally _high levels of water loss, or Non-Revenue Water (NRW)_  in survey the) 
...
+ Mixed performance could be related to the fact that in the past private companies were not vey transparent 
...
### Research Question(s) re: PHASE I (Suppliers)
...
<!-- how high is high?  -->
	...
	+ adopttion of SWITS / smart technology
...
3. Issues with COrruption / changes of ownership occurred around survey 
	+ refer to Desk Research... 

### Research Question(s) re: PHASE 2 (Households)

4. (In combinatin PHASE I & PHASE II<!--  // GWI? // Darcia's Note-->) could explore outcome **affordability** & (possibly) related variables to explore:  
	+ Financial assets
		+ Relevant tariff scheme
	+ Financial efficiency tools
	+ Governance structure  

<!-- ### Research Question(s) If I had historical and gegographic data 
