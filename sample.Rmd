...
How we obtained the Sample WSS Operators BRAZIL and what it looks like
...
> UPDATE FROM LAPOP 2019: LAPOP households interviews covered **1,498 IDs** located in **125 clusters**, found in **107 municipios**.[^1] 

[^1]: This information was retrieved from the STATA files with the sample of BRA 2016. 
...
<center>
![Brazil municipios covered by the WSS providers in POPA sample](./output/01_tmap_PopaSampleM.png) 
</center>
