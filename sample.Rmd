...
<center>
![LAPOP clusters](./output/Qgis_Lapop2016.png "LAPOP clusters ,over municipal boundaries, of hh surveyed in 2016"){width=250px} 
</center>
...
We arrived to a sample of **43 different suppliers**.  
...
<center>
![Brazil UFs covered by the WSS providers in POPA sample](./output/02_tmap_PopaSampleUF.png "Brazil UF covered by the WSS providers in POPA sample"){width=250px} 
</center>


<center>
![Brazil municipios covered by the WSS providers in POPA sample](./output/01_tmap_PopaSampleM.png "Brazil municipios covered by the WSS providers in POPA sample"){width=250px} 
</center>
